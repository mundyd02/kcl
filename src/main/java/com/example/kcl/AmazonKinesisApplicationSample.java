...
public final class AmazonKinesisApplicationSample {
    ...
    //public static final String SAMPLE_APPLICATION_STREAM_NAME = "test-counting-service-kinesis-stream-incremental-count";

    public static final String SAMPLE_APPLICATION_STREAM_NAME = "dpm-counting-service-incremental-test";
